...
<div class="modal fade" id="feature-request-modal" tabindex="-1" role="dialog">
                    ...
                    <article>
                        <div class="card no-border no-shadow mb-0 pb-0">
                            ...
                            <div id="success-message" style="display:none; color: green; padding: 10px; text-align: center; font-weight: bold;">
                             ...
                             {{ html()->form('POST', route('submit.feature.request'))->class('request_feature_form')->attribute('enctype', 'multipart/form-data') }}
