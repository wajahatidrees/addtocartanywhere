...
$(document).ready(function() {
    ...
    var APP_BASE_URL = 'https://newaddtocartanywhere.test';
    ...
    var myAppJavaScript = function($){
        ...
        // console.log('settingdata',settingdata);
                //previous page 
        // console.log(settingdata.show_hide_sold_out_button)
        ...
        if(settingdata.enable_app == 1) {       
                ...
                if(settingdata.show_widget_collection == 1){ 
                       ...
                       // console.log(productdata);
                        ...
                        for (var i = 0; i < productdata.length; i++) {
                                ...
                                //here we have add the hidden value in option                                var hiddehtml = ``;
                                var hidden=``;
                                ...
                                // Format values with store's currency
                                const formattedMinPrice = window.currency_with_format.replace(
                                  "{{amount}}",
                                  (formattedminPrice / 100).toFixed(2)
                                );
                                ...
                                if (formattedminPrice === formattedmaxPrice) {
                                    priceToShow = `
                                    <br>
                                    <p style="color:#1a5dbb; font-size:14px; font-weight:600; text-align:center;">
                                        Average Price:
                                    ...
                                    priceToShow = `
                                        <p style="color:#1a5dbb; font-size:14px; font-weight:600; text-align:left; margin:0 0 6px 0;">
                                            Price Range:
                                ...
                                const quantityButtons = {
                                    ...
                                    style3: `
                                            <div class="eosh_quantity counter style3" data-index="2">
                                                <div class="custom-input" style="background-color: ${settingdata.custom_quantity_color};">
                                                    <span style="margin-left: 12px;" class="num" min="1" name="quantity">1</span>
                                                    <div class="arrows">
                                                        <button style="" class="arrow up eosh_up plus inc">▲</button>
                                                        <button style="" class="arrow down eosh_down minus dec">▼</button>
                                                    </div>
                                                </div>
                                            </div>
                                            `,
                                ...
                                // ✅ 5 Button Designs Based on DB (Same pattern as quantityButtons)
                                const buttonHTML = {
                                    buttonstyle1: `
                                        <button id="" class="crtbtn cart-button-style1">
                                            <div class="preview-btn-container">
                                                <div class=" button-color" style="background: ${settingdata.custom_button_color || '#007bff'};">
                                        ...
                                        buttonstyle2: `
                                        <button  id="" class="crtbtn  btn-23 cart-button-style2"  style="background: ${settingdata.custom_button_color || '#007bff'};">
                                            <span   style="color: ${settingdata.custom_text_color || '#007bff'};" class="text">${settingdata.custom_text || 'Add to Cart'}</span>
                                            <span aria-hidden="true" style="color: ${settingdata.custom_text_color || '#ffffff'}; class="marquee">${settingdata.custom_text || 'Add to Cart'}</span>
                                        </button>`,

                                        buttonstyle3: `
                                        <button id="" class="crtbtn  btn3 cart-button-style3"  style="background-color: ${settingdata.custom_button_color || '#007bff'};">
                                            <span style="background-color: ${settingdata.custom_button_color || '#007bff'};" class="button_lg">
                                        ...
                                        buttonstyle4: `
                                        <button id="" class="crtbtn  cssbuttons-io-button cart-button-style4 button button4" style="background-color: ${settingdata.custom_button_color || '#007bff'};">
                                            ${settingdata.custom_text || 'Add to Cart'}
                                            <div class="icon">
                                ...
                                $.each(allvariants, function(key,currentVariant){
                                    ...
                                    if(!currentVariant.available){
                                        if (settingdata.show_hide_sold_out_button == 1) {
                                            var btn = `<button class="sold_out_btn disabled">Sold out</button>`;
                                        } 
                                    }else if(settingdata.append_to_button_style == 'icon' &&  selectedStyle && quantityButtons[selectedStyle] && settingdata.select_icon_postion == 'greenicon' || settingdata.append_to_button_style == 'quantityselector' ){ 
                                        var icon = `
                                            <div class="eosh_prod-card eosh_tenth">
                                            <div class="eosh_cart-quantity">
                                            ${settingdata.show_hide_button == 1 ? 
                                            `  <div class="custom-dropdown">
                                                    ${quantityButtons[selectedStyle] || ''}
                                                </div>
                                            ` 
                                            : ``}
                                    ...
                                    }else if(settingdata.append_to_button_style == 'icon'  &&  selectedStyle && quantityButtons[selectedStyle]  && settingdata.select_icon_postion == 'squarepluseicon' || settingdata.append_to_button_style == 'quantityselector' ){
                                        var icon = `
                                    ...
                                    }else if(settingdata.append_to_button_style == 'icon' && settingdata.select_icon_postion == 'roundpluseicon' || settingdata.append_to_button_style == 'quantityselector' || settingdata.append_to_button_style == 'quantityselector' ){
                                    ...
                                    }else if(settingdata.append_to_button_style == 'icon' && settingdata.select_icon_postion == 'blackicon' || settingdata.append_to_button_style == 'quantityselector' || settingdata.append_to_button_style == 'quantityselector'  ){
                                    ...
                                    }else if(settingdata.append_to_button_style == 'icon' && settingdata.select_icon_postion == 'whiteicon' || settingdata.append_to_button_style == 'quantityselector' || settingdata.append_to_button_style == 'quantityselector'  ){
                                    ...
                                    }else if( settingdata.append_to_button_style == 'button' &&  selectedStyle && quantityButtons[selectedStyle] || settingdata.select_button_style == 'rounded'  ){
                                                    
                                         var btn =` 
                                         <div class="eosh_prod-card eosh_fourth" style="z-index:1000;position:relative;display:flex;align-items:center;gap:10px;width: 250px;"> 
                                            <div class="eosh_cart-quantity"> 
                                                ${settingdata.show_hide_button == 1 ? 
                                                `   <div class="custom-dropdown">
                                                        ${quantityButtons[selectedStyle] || ''}
                                                ...
                                                ${buttonHTML[selectedButton].replace('<button', `<button id="${currentVariant.id}"`)}
                                         </div>
                                        
                                        <div class="showdata" style="display:block; display: flex; justify-content: center; align-items: center;">
                                        <p class="errorMessage"></p> 
                                        </div> `;
                                    }else if( settingdata.append_to_button_style == 'button' &&  selectedStyle && quantityButtons[selectedStyle]  && settingdata.select_button_style == 'square'  ){
                                        var btn =`
                                ...
                                $('.eosh-dropdown1').on('change', function() {
                                    var variantIds = [];
                                    let $parent = $(this).parent(); // scope to current container
                                
                                    let dropdownval1 = $(this).val();
                                    let dropdownval2 = $parent.find('#eosh-dropdown2').val() || '';
                                    let dropdownval3 = $parent.find('#eosh-dropdown3').val() || '';
                                
                                    let selectedtitle = `${dropdownval1}/${dropdownval2}/${dropdownval3}`.replace(/\/$/, '');
                                    selectedtitle = selectedtitle.replace(/\/$/, '');
                                
                                    $parent.find('#eosh-hiddenDropDown option').filter(function() {
                                        let optionvalue = $(this).text().replaceAll(/ /g, '');
                                        if (optionvalue == selectedtitle) {
                                            variantIds   = $(this).val();
                                            productprice = $(this).attr('product-price');
                                
                                            // ✅ Only update the option in THIS product's dropdown3
                                            let $option = $parent.find('#eosh-dropdown3 option').filter(function() {
                                                return $(this).val() === dropdownval3;
                                            });
                                            ...
                                            $parent.closest('.card-wrapper').find('.card__media img').attr('srcset', imageUrl);
                                        } else {
                                            var messageError = 'product is unavailable';
                                        }
                                    });
                                
                                    $parent.find('.eosh_cart-btn').attr('id', variantIds);
                                });
                                ...
                                $('.eosh-dropdown2').on('change', function() {
                                    ...
                                    let dropdownval1 = $parent.find('#eosh-dropdown1').val() || '';
                                    let dropdownval3 = $parent.find('#eosh-dropdown3').val() || '';
                                
                                    // ✅ Build the selected title (remove trailing slash + spaces)
                                    let selectedTitle = `${dropdownval1}/${dropdownval2}/${dropdownval3}`
                                        .replace(/\/$/, '')
                                        .replace(/ /g, '');
                                
                                    $parent.find('#eosh-hiddenDropDown option').each(function() {
                                        let optionValue = $(this).text().replace(/ /g, '');
                                        if (optionValue === selectedTitle) {
                                            variantId = $(this).val();
                                            productPrice = $(this).attr('product-price');
                                
                                            // ✅ Update dropdown3 option text with price
                                            let $option = $parent.find('#eosh-dropdown3 option').filter(function() {
                                                return $(this).val() === dropdownval3;
                                            });
                                    ...
                                    if (variantId) {
                                        $parent.find('.eosh_cart-btn').attr('id', variantId);
                                    } else {
                                        console.warn('Product is unavailable');
                                        $parent.find('.eosh_cart-btn').attr('id', ''); // clear if unavailable
                                    }
                                });           
                        } 
                } 
            ...
            if((window.location.pathname.indexOf("products/") > -1)){
                ...
                var btn =`<button style="background-color:red; width:40px; height:40px;"class="crtbtn square eosh_cart-btn pointer"><p>add to cart</p></button>`;
                $('.price-item--last').append(btn);   
            }
            ...
            function setupQuantityButtons() {
                ...
                $(document).on('click', '.eosh_up.plus', function(event) {
                    ...
                    event.stopPropagation();
                      ...
                      // Check if .arrows exists and use the correct selector
                        if ($(this).closest('.arrows').length) {
                            numElement =  $(this).closest('.arrows').parent().find('.num');
                        } else {
            ...
            function updateQty(item, pointer, actionType) {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (settingdata.redirectPolicy === "REDIRECT_TO_CHECKOUT") {
                            location.href = "/checkout";
                        } else if (settingdata.redirectPolicy === "REDIRECT_TO_CART") {
                            location.href = "/cart";
                        } else if (settingdata.redirectPolicy === "REDIRECT_TO_PRODUCT_PAGE") {
                            location.href = `/products/${checkhandle}`;
                        }else if(settingdata.redirectPolicy === "REMAIN_ON_PAGE") {
                            // Default: stay on page or open cart drawer
                            console.log("Item added, staying on page");
                        }
                    },
                    error: function (data) {
