$(document).ready(function() { 
        ...
        var eoProductContainer = [ 
            
            ".Grid__Item",".product-block__inner .image-inner","li.grid__item",".collection__main",".price-list","a product-card-link",
            ".product-card",".grid-item__content",".product-item__inner",".grid-product__content",
            
            ".collection__grid--container",".Grid__Item",".product-block__inner .image-inner","li.grid__item",".collection__main",".price-list","a product-card-link",
            ".product-card",".grid-item__content",".product-item__inner",".grid-product__content"];
        var eoProductSelector = eoProductContainer.toString();
      
        var eoProductCartContainer = [
            
            ".mb__5",".Price",".price .theme-money",".price__container",".price-list",".money",".grid-product__price--current",
            ".product-item__price:last",".grid-product__price",
            
            
            ".price__sale" ,".mb__5",".Price",".price .theme-money",".price__regular",".price-list",".money",".grid-product__price--current",
        ".product-item__price:last",".grid-product__price"];
        ...
        if(settingdata.enable_app == 1){               
            ...
            //                                     }
            //                                     else{
            //          ".card__badge",                               var messageError = 'product is  unavailable';
            //                                     }
            //                                 });
            //                                 $(this).parent().find('.eosh_cart-btn').attr('id',variantIds);
            //                             });
            ...
            // }
             ...
             if( window.location.pathname == '/'){    
                    if(settingdata.show_widget_home == 1){    
                        ...
                        ${settingdata.show_hide_button == 1 ? 
                        `<div class="eosh_quantity pointer">
                        <spa".card__badge",n class="eosh_down minus">
                        <svg width="5" height="3" viewBox="0 0 5 3" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path class="pluseminus" d="M0.0980001 0.844H4.598V2.338H0.0980001V0.844Z" fill="#2C2C2C"/>
                        </svg> 
                        </span>
            ...
            function initbutton(){
                ...
                var num = document.querySelectorAll('span.num');
               
                for (let count = 0; count < plus.length; count++) {
                    plus[count].addEventListener("click", function() {
                        var currentQuantity = parseInt(num[count].innerText);
                        num[count].innerText = currentQuantity + 1;
                    });
            
                    minus[count].addEventListener("click", function() {
                        var currentQuantity = parseInt(num[count].innerText);
